    ...
    <SubscriptionGuard type="jobs">
      <div className="jobs-page animate-fade">
        ...
        <style jsx>{`
          ...
          .job-card { padding: 0; overflow: hidden; height: 100%; border: 1px solid #FFFFFF; background: #FFFFFF; }
          ...
          .job-status-badge { font-size: 0.75rem; font-weight: 700; text-transform: uppercase; background: rgba(16, 185, 129, 0.1); color: var(--status-success); padding: 4px 10px; border-radius: 20px; border: 1px solid rgba(16, 185, 129, 0.3); }
          ...
          .job-footer { margin-top: auto; display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid #FFFFFF; }
